...
These measures reflect increasingly broad notions of cultural similarity. Shared nationality captures common institutional and cultural background. Shared official language captures communication potential through the language used in formal and public life. Shared ethnic language recognizes that communication costs may also be lower between teammates who share a widely-spoken native language even when it is not their countries' official language, so Language Proximity and Same Language can diverge whenever a country's official language differs from its most widely spoken native language.
...
Table 2: \textcolor{red}{I would remove Panel B and add the absolute number of partnerships next to the share in Panel A, 42.2\%=X teams for each of the 3 measure.}  In our sample,  \textcolor{red}{42.2\%} of teams consist of players sharing the same nationality, \textcolor{red}{56.0\%} share an official language, and \textcolor{red}{56.8\%} share a widely-spoken ethnic language (linguistic proximity).
...
\multirow{2}{*}{Ling.\ proximity} & Actual & 56.8\% & 50.6\% & 56.5\% \\
...
Ling.\ proximity & 55.7\% & 55.1\% & 55.6\% & 55.2\% & 58.0\% & 60.2\% \\
\midrule
...
The share of same-nationality teams is remarkably stable across the Tokyo cycle's three periods, at 40.0\%, 40.3\%, and 39.0\%, respectively (Table~\ref{tab:t2ab}). The corresponding shares for shared official language are 54.8\%, 55.0\%, and 54.8\%, while linguistic proximity is 55.7\%, 55.1\%, and 55.6\%.
...
The Paris cycle provides a contrasting pattern (Table~\ref{tab:t2ab} and Figure~\ref{fig:cycle_nat}). Same-nationality partnerships account for 39.3\% of teams before the Paris Games, 42.6\% during the preparation period, and 43.9\% afterwards. Shared-language partnerships increase from 54.1\% to 57.6\% and then 58.8\%, while linguistic proximity rises from 55.2\% to 58.0\% and then 60.2\%.
