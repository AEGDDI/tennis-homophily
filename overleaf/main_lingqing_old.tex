...
\added{Alternative specification: randomly assign one team per match as the focal team to be kept in the regression analysis (N=1,864). Coefficients are of similar magnitude and slighter weaker significance.} \textcolor{red}{Repeated over 10 random seeds: the same-nationality AME averages 0.0466 (range 0.0161--0.0812, significant at the 5\% level in 5 of 10 draws), same-language averages 0.0517 (range 0.0230--0.0877, significant in 7 of 10 draws), \textcolor{blue}{and, for linguistic proximity averages 0.0656 (range 0.0236--0.0944, significant in 7 of 10 draws)}.}

\textcolor{red}{Where are the results table of the alternative specification? Each table in the appendix needs to be referred in the main text somewhere.}
