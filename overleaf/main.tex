...
In increasingly international and self-organized work environments, cultural similarity may be one dimension along which individuals sort into collaborations. %While experiments have compared performance of self-sorted and randomly assigned teams, evidence from naturally occurring professional partnerships is more limited. 
We examine relationship between cultural similarity and team performance where teams are self-organized using men’s doubles tennis matches at the four Grand Slam tournaments. We measure cultural similarity using nationality,  language, and linguistic proximity. Culturally similar teams are more likely to win matches. This association has a clear boundary: it disappears in tiebreaks, where teams are closely matched and outcomes are determined over few points. The association strengthens with professional experience but not with partners' experience gap. Finally, although cultural sorting in team formation is substantial, higher-ranked players are not systematically more likely to choose culturally similar partners, suggesting that the performance association is not simply driven by sorting among stronger players.
\end{abstract}
\newpage
\setcounter{page}{1}
\section{Introduction}
%\textcolor{red}{Self-sorting collaboration in international working environment $-->$ cultural similarity $-->$ team formation}
...
This raises an important question: \lq\lq When individuals have substantial discretion over whom they collaborate with,  does cultural similarity between the resulting collaborators translate into better performance?" 

The empirical evidence answering this question across corporate, academic, and sports suggests that teams sorted by cultural homophily often receive a performance penalty, though the exact boundaries remain heavily debated. In entrepreneurial and ventures, Gompers, Mukharlyamov, and Xuan (2016) find that ethnic homophily in self-selected entrepreneurial teams reduces investment success rates. In academics, Freeman and Huang (2015) document  that culturally homogeneous research teams  receiving fewer citations than their diverse counterparts. In sports, Békés and Ottaviano (2025) show that culturally similar players are more likely to pass the ball to one another within elite football teams; however, they note that such patterns do not necessarily translate into better overall team performance. Synthesizing these complex dynamics, a comprehensive meta-analysis by Stahl, Maznevski, Voigt, and Jonsen (2010) suggests that the ultimate effect of cultural diversity on team performance is not universal and depends heavily on the specific nature of the task environment, highlighting a critical need for research that can isolate these boundary conditions.

To empirically answer this need  requires an alternative setting in which partner formation, real-time coordination, and subsequent team performance can all be observed simultaneously. Professional doubles tennis provides a unique real-world setting with these exact desirable features. The workplace is international, where two individuals bilaterally form a partnership and operate under high-stakes economic incentives to maximize joint success in various competing conditions.  Moreover, as individual contributions during play are directly observable, it limits concerns about unobserved effort and free-riding that frequently complicate team-performance measures in traditional corporate settings. Unlike academics—where unpublished research outputs or failed collaborations remain unobservable—the outcome of a doubles tennis match is always observable as a clean, binary win or loss. Similarly, unlike big team sports such as football—where players may have discretion over micro-level bilateral passing, but the entire team is ultimately assembled by a manager or coach—the collaboration in doubles tennis is entirely self-organized and organically formed.
\begin{comment}
Paul A Gompers et al (2012) find ethnic homophily in self-selected entrepreneurial teams does not increase a team's investment success. In academics, Freeman and Huang (2015) document that culturally self-sorted homogeneous teams face a distinct quality penalty, receiving fewer citations than diverse teams. %Tonellato (2025) Journal of Management Surgical teams; Dale-Olsen and Finseraas (2019) find higher workforce linguistic diversity decreases productivity in Manufactures. 
In sports, Békés and Ottaviano (2025) show that culturally similar players are more likely to pass to one another within elite football teams,  however, such pattern may not necessarily enhance the overall performance.
%Huang et al (2023) \lq\lq Wearing the Same Jersey?" find a higher level of cultural diversity enhanced the entire on-field performance. 
A meta analysis by Sthal et al (2021) suggest that the effect of cultural diversity on team performance  is not universal and depends on the nature of the task, highlighting the urgent need for future research. %Yet whether cultural similarity between collaborators ultimately translates into better team performance, particularly when collaborators themselves have substantial discretion over partner selection, remains less clear.
%This raises a more specific question: \lq\lq When individuals have substantial discretion over whom they collaborate with, under what condition does cultural similarity between the resulting collaborators translate into better performance?" 


Answering this question requires a setting in which partner formation and subsequent team performance can both be observed. Professional doubles tennis provides a unique real world setting with desirable features. 
The workplace is international. Two individuals bilaterally form a partnership and jointly work in a transparent team-production environment: individual contributions during play are directly observable, limiting concerns about unobserved effort and free-riding that can complicate team-performance measures in other settings. Individuals operate under high-stake economic incentives to maximize joint success under various competing conditions. \textcolor{red}{More importantly, unlike academics where unpublished research outputs may not be observable, the outcome of doubles tennis match is always observable, winning or losing; unlike football where players may have discretion of bilateral collaboration but the entire team is assembled by the manager and coach, the collaboration of doubles tennis is entirely self-organized. }
...
In this paper, we leverage these unique institutional advantages to examine 1) the relationship between cultural similarity and team performance in a high-velocity working environment, 2) the boundary conditions of this relationship when communication windows are limited, and 3) the extent to which cultural similarity reflects systematic partner sorting in our setting.\footnote{Partnership formation in professional doubles tennis is inherently multidimensional. Players may sort on several characteristics, including playing ability and experience, strategic complementarity, and institutional or commercial connections such as shared representation by an agency or sponsorship arrangement. Our analysis abstracts from these multiple dimensions of partner selection and focuses on cultural similarity as one potentially consequential dimension of the resulting partnership.} By evaluating this setting, we are able to show how the benefits of cultural similarity depend on the immediate operational context and the specific time constraints under which teams must perform.

We collect data from all the men's doubles matches in Grand Slams between 2018 and 2025.  Cultural similarity are measured along three complementary dimensions: shared nationality, shared official language, and  language  proximity. We first examine whether culturally similar teams are more likely to win their matches. We then use tiebreak outcomes to examine a theoretically important boundary condition: whether the association remains visible when the opportunity for teammates to coordinate is sharply compressed. Tiebreaks are played to decide a set once the score reaches 6--6. They are short and closely contested in which relatively few points determine the outcome and teammates have fewer opportunities to communicate and adjust during play.\footnote{Much like a penalty shootout in football, a tennis tiebreak breaks a draw by shifting the match into a rapid-fire point-by-point format where losing a point on your own serve is the psychological equivalent of missing a penalty kick, as the alternating sequence means a single miss often decides the entire set.}
...
We find that culturally similar teams are 3.8 to 4.7 percentage points more likely to win  matches, robust across all playing surfaces.\footnote{Tennis Grand Slams are contested across three distinct structural profiles: grass at Wimbledon, clay at the French Open, and hardcourts at the Australian and US Opens. The surfaces may fundamentally alter game strategies and communication dynamics.} This association, however, disappears in tiebreaks, where the competing teams have already demonstrated closely matched performance, and the outcome is determined over a short sequence of points that provides relatively little time and opportunity for teammates to communicate, adjust, and coordinate. %The potential benefits of cultural similarity may therefore be too small to become visible under these conditions. 
If culturally similar teams were simply stronger for some persistent reason unrelated to coordination, we would expect their advantage to remain visible in tiebreaks. Instead, the association is present when performance is aggregated over the entire match but not when the outcome is determined over a short, closely contested sequence. We interpret this contrast as evidence of a boundary condition on when cultural similarity can be associated with team performance, rather than as evidence of a universal performance advantage.
...
%We then investigate two distinct roles of professional experience through which cultural similarity may be associated with team performance. First, more experienced players have accumulated greater task-specific knowledge and familiarity with high-level competition. Shared language and cultural background may facilitate communication and help teammates integrate this knowledge into coordinated action. If so, the association between cultural similarity and performance should be stronger among teams with greater professional experience. Second, cultural similarity may facilitate knowledge transfer through communication between experienced and less experienced teammates. If so, the association should strengthen with the within-team experience gap. We find the association between cultural similarity and match performance becomes stronger with team average professional experience, but not more valuable when teammates differ more in experience, suggesting that cultural similarity complements accumulated professional experience in communication and coordination.

We then investigate how professional experience modulates this relationship by exploring two distinct human capital channels. First, a shared cultural background may function as a conduit that helps experienced teammates rapidly integrate their accumulated task-specific knowledge into coordinated action, implying that the association should strengthen with team average experience. Second, cultural similarity may act as a bridge for knowledge transfer between senior and junior teammates, suggesting the association should increase with the within-team experience gap. Our results support the former channel: the association between cultural similarity and match success is significantly amplified by team average experience, but is unaffected by the experience gap. This suggests that cultural similarity complements the total pool of accumulated professional human capital rather than serving as a tool to bridge internal status hierarchies.

Finally, we return to the endogenous team formation stage. We document the extent of cultural sorting in partnerships, examining whether the sorting is related to  players' ability. Cultural similarity is substantially more common among observed partnerships (x\%) than under random matching (x\%), confirming that doubles teams are strongly sorted by nationality and language. However, this sorting is not more pronounced among higher-ranked players, and a player's own ranking is, if anything, negatively associated with having a culturally similar partner. We therefore find no evidence for the specific selection explanation in which stronger players systematically choose culturally similar partners.\footnote{\added{Freeman and Huang (2015): if weaker scholars collaborate locally while stronger scholars can reach out internationally, it can cause culturally similar teams produce lower quality output. But this goes against our finding.}} Nevertheless, this  cannot rule out other forms of endogenous partner selection that we do not observe.

Our study relates to three strands of literature. First, it contributes to research on cultural diversity, or similarity, and organizational performance. Economic models emphasize that cultural diversity can generate informational and productivity benefits while also creating communication and coordination costs (Lazear, 1999). Organizational research similarly identifies both benefits and costs of cultural diversity, including greater creativity and knowledge variety but also conflict, weaker social integration, and coordination difficulties (Stahl et al., 2010; Harrison and Klein, 2007). Consistent with these competing forces, evidence on cultural composition and team performance is mixed and context dependent. Much of this literature examines diversity at the workforce or team level. We instead focus on cultural similarity within a small, highly interdependent dyad, where partners must coordinate continuously to produce a common outcome. In such settings, shared language and cultural background may directly facilitate communication and anticipation of a partner’s actions.
...
\textcolor{red}{For LJ: Rewrite paragraph below depending on the results of diff nat and same lang.}
...
%Taken together, these literatures suggest that culture matters at both the formation and performance margins of collaboration. Our study bridges these findings by introducing an empirical setting that combines organic partner selection, dyadic cultural metrics, and objective performance under direct competition. 
We make three distinct contributions. First,  we connects organic selection directly to objective performance: We extend the literature on endogenous team formation by showing how bilateral cultural sorting translates into objective competitive outcomes, complementing studies like Békés and Ottaviano (2025) that map internal biases within forced team structures. Second, we identifies the temporal boundaries of cultural sorting: We show that the positive association between cultural similarity and performance is strictly bounded by the time window available for strategic communication and completely disappears under the acute time shocks of tiebreaks. Finally, we isolates the human capital pathways: We show that the homophily premium is heavily amplified by the total pool of team expertise (team average experience) but is unaffected by internal status hierarchies (within-team experience gaps), supporting a coordination-based interpretation.
...
The remainder of the paper is organized as follows. Section 2 describes the data, measures of cultural similarity, and construction of the empirical sample. Section 3 develops the theoretical framework and formalizes our hypotheses. Section 4 presents the main empirical analysis,   evaluating the baseline association between cultural similarity and performance, its robustness across playing surfaces as well its  boundary condition, and the moderating pathways of professional experience. Section 5 returns to cultural sorting in the formation of partnerships and examines whether the sorting is related to players’ ability. Section 6 concludes with a discussion of broader implications for both individual and organizational management.
\section{Data}
\subsection{Empirical Setting and Sample}
Our empirical setting consists of men's doubles matches from the four Grand Slam tournaments, the Australian Open, Roland Garros, Wimbledon, and the US Open, between 2018 and 2025. The dataset contains 1,864 completed Grand Slam doubles matches and $3{,}728$ team-match observations.%\footnote{\textcolor{red}{From the initial dataset of 1,921 Grand Slam doubles matches, we exclude retirements and walkovers because these outcomes do not reflect normal competitive performance. We further remove matches with incomplete doubles ranking information that cannot be reliably recovered, resulting in a final sample of 1,864 matches.}}
...
\begin{tablenotes}
\small
\item Note: In 2020, due to Covid, Wimbledon  did not take place and US Open 2020 halved the draw of men's doubles. From the initial dataset of 1,921 Grand Slam doubles matches, we exclude retirements and walkovers because these outcomes do not reflect normal competitive performance. We further remove matches with incomplete doubles ranking information that cannot be reliably recovered, resulting in a final sample of 1,864 matches.
\end{tablenotes}
}
...
\begin{tablenotes}
\small
\item Note: %Individual-level statistics pool both teammates across all 3,728 team-obs (4 players $\times$ 1,864 matches, minus a small number with missing tenure/DOB). 
Team-level statistics are the two-teammate average used directly in the regressions (\textit{rank\_mean}, \textit{exp\_mean}, \textit{age\_mean}). Years since turning pro is imputed to 1 for 216 team-obs whose raw tenure is $\le 0$ (rookies who turned pro in or just after the tournament year). %the team-level mean above reflects this imputation.
\end{tablenotes}
\end{threeparttable}
\end{table}
%\FloatBarrier
...
\subsection{Measuring Cultural Similarity [rewrite!]}

\textcolor{blue}{We construct three measures of cultural similarity. The first measure, \textit{Same Nationality}, equals one if both teammates represent the same country and zero otherwise. The second measure, \textit{Same Language}, equals one if both teammates share an official national language and zero otherwise. It is built from the \textit{comlang\_off} indicator in the CEPII Gravity database \citep{contecotterlazmayer2022}, merged onto each team by the two players' ISO3 nationality codes; teams sharing the same nationality are set to 1 by definition, since the source table does not include self-pairs, and teams whose specific country pair is not found in the table (both nationalities known, but not a recorded match) default to 0 rather than being dropped. The third measure, \textit{Linguistic Proximity}, is a continuous index on $[0,1]$ built from Ethnologue's language-tree classification \citep{melitztoubal2014}, obtained from the authors' own data repository (\texttt{faridtoubal.com/Paper/LangJIE/lang.html}) since CEPII's distribution link for this specific table is no longer active. We adopt this continuous, tree-based measure as our main-text linguistic-similarity indicator, rather than a binary same-language indicator, for two reasons: it distinguishes teammates who speak closely related but distinct languages (e.g.\ Italian and Spanish, both Romance languages) from teammates whose languages are totally unrelated; and it is the same measure \citet{bekesottaviano2025} use to characterize linguistic similarity between teammates in the most closely related existing study of cultural homophily within small, interdependent teams, allowing our results to be compared directly to theirs. \citet{melitztoubal2014} score each pair of \emph{languages} on a coarse ordinal scale according to how many levels of the Ethnologue family tree they share (e.g.\ two languages in the same branch but a different sub-branch score $0.5$), and the resulting \emph{country}-pair value is a population-weighted average across each country's principal languages. For example, Belgium is absent from their table; we then construct its value against any other country as the population-weighted average of the Netherlands' and France's own values against that country, using Belgium's approximate Dutch/French population shares ($59\%$/$41\%$) as weights, the same treatment Melitz and Toubal (2014) themselves apply to other multi-language countries such as Switzerland. This gives Belgium a linguistic-proximity value of $0.56$ against France ($0.59\times0.25+0.41\times1.00$: Dutch and French sit in different branches of the same language family, while French scores trivially $1.00$ against itself) and $0.69$ against the Netherlands ($0.59\times1.00+0.41\times0.25$). The measure is defined at the country level from each country's aggregate population-language composition, not at the level of the individual player: a bilingual player is assigned the value implied by their playing nationality, with no separate adjustment for their own personal language repertoire.} \footnote{An alternative binary construction of linguistic proximity (CEPII's \textit{comlang\_ethno}, one if both teammates share a widely-spoken ethnic language and zero otherwise, defined as a language spoken as a mother tongue by at least 9\% of the population in both countries) and two further continuous constructions from \citet{psw2024} are reported as robustness checks in Appendix~\ref{app:langprox}.}


%\footnote{Monaco is entirely absent from the raw CEPII gravity table's language variables and from the raw Melitz \& Toubal (2014) language-proximity table. For Same Language (and its Appendix binary counterpart), we manually set Monaco pairings against another French-official-language country (France, Belgium, Switzerland, Canada, Luxembourg) to 1, reflecting that French is Monaco's sole official language; other Monaco pairs default to 0. For \textit{prox1}, Monaco pairings against a French-official-language country are set to 1, and any other Monaco pair uses France's \textit{prox1} value against that country as a stand-in, reflecting that Monaco's population is francophone. This affects 39 raw match observations for Same Language and 97 for \textit{prox1}. \textcolor{blue}{Belgium is likewise entirely absent from the raw Melitz \& Toubal table (though present, correctly, in the CEPII language tables underlying Same Language). Since Belgium's population is split between Dutch and French speakers (official-language shares of approximately 59\% and 41\%, respectively), we construct its \textit{prox1} value against every other country as the population-weighted average of the Netherlands' and France's own \textit{prox1} values against that country -- the same two-language-blend approach Melitz and Toubal (2014) use for countries such as Switzerland. This affects 22 raw match observations. South Korea is the only remaining country entirely absent from the raw table; as a linguistic isolate with no other country sharing its official language, no analogous stand-in is available, so South Korea pairings default to 0 (14 raw match observations affected).}}


These measures reflect increasingly broad notions of cultural similarity. Shared nationality captures common institutional and cultural background. Shared official language captures communication potential through the language used in formal and public life. Linguistic proximity recognizes that communication costs may be lower between teammates whose languages are closely related even when they do not share the same official language.  %Language Proximity and Same Language can diverge substantially -- e.g. two Romance-language speakers score a high \textit{prox1} without sharing an official language.

In our sample, \textcolor{red}{42.2\%} (882 teams) of teams consist of players sharing the same nationality, \textcolor{blue}{56.7\% (1,184 teams)} share an official language, and \textcolor{blue}{the mean of the continuous measure linguistic proximity is 0.654}.
...
Measure & Share & Teams \\
\midrule
Same nationality  & 42.2\% & 882 \\
Same language  & \textcolor{blue}{56.7\%} & \textcolor{blue}{1,184} \\
\textcolor{blue}{Ling.\ proximity (mean)} & \textcolor{blue}{0.654} & \textcolor{blue}{--} \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item Note: Computed over the 2,089 distinct tournament$\times$partnership pairings with complete ranking data (542 at the Australian Open, 543 at Roland Garros, 487 at Wimbledon, 517 at the US Open). "Teams" is the absolute number of the 2,089 partnerships satisfying each binary criterion; \textcolor{blue}{linguistic proximity is a continuous $[0,1]$ measure with no natural satisfying/non-satisfying split, so its row instead reports the mean over all 2,089 partnerships.}
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
%To explain how cultural sorting impacts team success under time constraints, we draw on the theory of Shared Mental Models (SMM). A shared mental model represents an overlapping cognitive framework among teammates regarding task requirements, strategic execution, and interdependent routines [Cannon-Bowers et al., 1993]. In international and fluid labor markets, cross-cultural team formations introduce significant "communication taxes"—including linguistic friction and mismatched implicit norms—which delay the alignment of these cognitive frameworks [Stahl et al., 2010].Conversely, we argue that a shared cultural and linguistic background functions as a coordination subsidy. It provides a baseline of shared scripts and low-friction communication that allows self-sorted teams to formulate, adjust, and execute shared mental models rapidly on the fly. However, the value of this cognitive subsidy is highly dynamic and depends entirely on the specific time windows available to the team for explicit strategic processing. 


 %When teams operate in fast-paced, competitive environments, they face ongoing external threats that require real-time tactical troubleshooting. SMM theory suggests that a team's performance relies heavily on its capacity to engage in explicit strategic alignment—pausing to diagnose errors, update strategies, and realign their joint mental models [Marks et al., 2001]. In our empirical setting, standard gameplay provides regular, dedicated structural windows for this explicit communication via 90-second changeovers and multi-minute set breaks. During these strategic pauses, culturally and linguistically similar teams can rapidly articulate complex adjustments with minimal linguistic friction and high baseline trust, smoothly integrating their individual human capital into coordinated action. Because these regular pauses allow homogeneous teams to fully exploit their shared mental models to outmaneuver opponents, we expect a robust baseline performance advantage in standard match play.
 
 \added{Hypothesis 1 (H1): In organic, bilaterally self-sorted teams operating under tight real-time constraints, cultural and linguistic similarity is positively associated with team performance when strategic communication windows are available.} 
 
 %The Mitigation of the Premium under Acute Time Shocks: While cultural homophily provides a powerful subsidy for high-level strategic alignment, its utility is highly bounded by the time available to process complex information. As the velocity of an execution environment increases to an acute time shock, the nature of team interaction undergoes a fundamental transition, shifting from explicit strategic troubleshooting to rapid, protocol-driven execution. When the environment transitions into a tiebreak, the strategic communication channel is structurally closed as the 90-second macro-pauses are entirely eliminated. Although teammates maintain the ability to communicate brief, tactical signals between points, this micro-level communication relies strictly on highly standardized, universal professional codes and non-verbal routines native to the sport. Because these rapid operational signals bypass deep cultural contextualization or native linguistic processing, the communication barriers faced by diverse teams drop to zero, effectively leveling the playing field. Therefore, when explicit strategic alignment is blocked and teams are restricted to protocol-driven tactical signaling, the marginal utility of a shared cultural background evaporates.
 
 \added{Hypothesis 2 (H2): Under an acute time shock that structurally eliminates strategic communication windows, the positive association between cultural similarity and team performance disappears.}
...
\subsection{The Moderating Pathways of Professional Experience}

\added{We further refine this framework by exploring how the total pool and internal distribution of team expertise alter the utilization of this shared communication channel. We evaluate two distinct human capital pathways through which experience modulates the homophily premium. First, a shared cultural background may function as a conduit that helps highly experienced teammates rapidly integrate their deep, individual repositories of task-specific knowledge into a unified strategy during tight strategic windows. If cultural similarity complements accumulated professional human capital, the homophily premium should strengthen with the overall maturity of the unit (team average experience). Second, cultural similarity may act as a vehicle for internal knowledge transfer, facilitating real-time instruction and coaching between senior and junior peers, implying that the premium should increase with the within-team experience gap.}

Hypothesis 3a (H3a): The positive association between cultural similarity and team performance in standard play is stronger among teams with greater average professional experience.

Hypothesis 3b (H3b): The positive association between cultural similarity and team performance in standard play is stronger among teams with a larger within-team experience gap.
...
\midrule
Cultural similarity & 0.0361** & \textcolor{blue}{0.0420***} & \textcolor{blue}{0.0501**} \\
 & (0.0164) & \textcolor{blue}{(0.0157)} & \textcolor{blue}{(0.0202)} \\
Own avg. doubles ranking & $-$0.0007*** & $-$0.0007*** & $-$0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0007*** & 0.0007*** & 0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1)& $-$0.0042 & \textcolor{blue}{$-$0.0032} & \textcolor{blue}{$-$0.0031} \\
 & (0.0315) & \textcolor{blue}{(0.0315)} & \textcolor{blue}{(0.0314)} \\
Team avg. professional years  & 0.0044*** & \textcolor{blue}{0.0042**} & \textcolor{blue}{0.0043***} \\
 & (0.0017) & (0.0017) & \textcolor{blue}{(0.0017)} \\
Team avg. professional years$^2$  & $-$0.0008*** & $-$0.0008*** & $-$0.0008*** \\
 & (0.0002) & (0.0002) & (0.0002) \\
\midrule
Tournament $\times$ year FE & Yes & Yes & Yes \\
Match round FE & Yes & Yes & Yes \\
Pseudo-$R^2$ & 0.096 & 0.097 & \textcolor{blue}{0.096} \\
$N$ & 3,728 & 3,728 & 3,728 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item *** p$<$0.01, ** p$<$0.05, * p$<$0.10. Standard errors in parentheses, clustered by match. \textcolor{red}{In Column (1), cultural similarity is equal to 1 if sharing the same nationality, and zero otherwise. In Column (2), cultural similarity is equal to 1 if sharing the same official language, and zero otherwise. In Column (3), cultural similarity is measured by linguistic proximity on a 0-1 continuous scale.} Unit of observation is team-match (2 team obs. per match); Professional years (Experience) is demeaned at the sample mean (11.93 years)
...
\textcolor{red}{Adjust the table width to text width}
...
Across all three specifications, culturally similar teams are significantly more likely to win Grand Slam matches. The estimated effects range from 3.6 to 5.0 percentage points and are strongest for linguistic proximity, measured on a continuous scale. Team quality are the dominant predictor of success: stronger own doubles rankings significantly increase the probability of winning, while stronger opponent rankings significantly decrease the probability of winning. Whether having a top 100 singles player in the team does not seem to matter for the match outcome. More experienced teams perform better with diminishing returns.

\added{Alternative specification: randomly assign one team per match as the focal team to be kept in the regression analysis (N=1,864). Coefficients are of similar magnitude and slighter weaker significance.} Repeated over 10 random seeds (Appendix Table~\ref{tab:b1}): the same-nationality AME averages 0.0466 (range 0.0161--0.0812, significant at the 5\% level in 5 of 10 draws), \textcolor{blue}{same-language averages 0.0477 (range 0.0215--0.0847, significant in 6 of 10 draws)}, \textcolor{blue}{and, for linguistic proximity averages 0.0656 (range 0.0236--0.0944, significant in 7 of 10 draws)}.
...
\midrule
Cultural similarity (C) & 0.0395** & 0.0351* & \textcolor{blue}{0.0392**} & \textcolor{blue}{0.0442**} & \textcolor{blue}{0.0541**} & \textcolor{blue}{0.0486**} \\
 & (0.0183) & (0.0189) & \textcolor{blue}{(0.0176)} & \textcolor{blue}{(0.0182)} & \textcolor{blue}{(0.0224)} & \textcolor{blue}{(0.0234)} \\
Surface & 0.0097 & $-$0.0017 & \textcolor{blue}{$-$0.0043} & \textcolor{blue}{0.0052} & \textcolor{blue}{0.0158} & \textcolor{blue}{$-$0.0028} \\
 & (0.0149) & (0.0142) & \textcolor{blue}{(0.0208)} & \textcolor{blue}{(0.0189)} & \textcolor{blue}{(0.0308)} & \textcolor{blue}{(0.0285)} \\
C $\times$ Surface & $-$0.0169 & 0.0023 & \textcolor{blue}{0.0112} & \textcolor{blue}{$-$0.0094} & \textcolor{blue}{$-$0.0203} & \textcolor{blue}{0.0034} \\
 & (0.0376) & (0.0347) & (0.0364) & (0.0340) & \textcolor{blue}{(0.0474)} & \textcolor{blue}{(0.0438)} \\
\midrule
Controls  & Yes & Yes & Yes & Yes & Yes & Yes \\
Round FE & Yes & Yes & Yes & Yes & Yes & Yes \\
Tournament $\times$ year FE & No & No & No & No & No & No \\
Pseudo-$R^2$ & 0.096 & 0.096 & 0.097 & 0.097 & \textcolor{blue}{0.096} & \textcolor{blue}{0.096} \\
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity & 0.0308 & \textcolor{blue}{0.0087} & \textcolor{blue}{0.0388} \\
 & (0.0224) & (0.0218) & \textcolor{blue}{(0.0277)} \\
Own avg. doubles ranking & $-$0.0003*** & $-$0.0003*** & $-$0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0003*** & 0.0003*** & 0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1) & $-$0.0675 & $-$0.0646 & \textcolor{blue}{$-$0.0672} \\
 & (0.0428) & (0.0427) & \textcolor{blue}{(0.0428)} \\
Team avg. professional years & 0.0027 & 0.0023 & \textcolor{blue}{0.0026} \\
 & (0.0022) & (0.0021) & \textcolor{blue}{(0.0022)} \\
Team avg. professional years$^2$ & 0.0000 & 0.0001 & \textcolor{blue}{0.0000} \\
 & (0.0003) & (0.0003) & \textcolor{blue}{(0.0003)} \\
\midrule
Tournament $\times$ year FE & Yes & Yes & Yes \\
...
Table \ref{tab:t4} reports the results. None of the three measures of cultural similarity is significantly associated with the probability of winning a tiebreak.  The ranking controls remain highly significant, indicating that the specification continues to capture underlying differences in team quality.
...
%\added{Short version: First, a shared cultural background may function as a conduit that helps highly experienced teammates rapidly integrate their deep, individual repositories of task-specific knowledge into a unified strategy during tight strategic windows. If cultural similarity complements accumulated professional human capital, the homophily premium should strengthen with the overall maturity of the unit (team average experience). Second, cultural similarity may act as a vehicle for internal knowledge transfer, facilitating real-time instruction and coaching between senior and junior peers, implying that the premium should increase with the within-team experience gap.}
...
\subsubsection{Average Professional Experience} 
...
Table \ref{tab:t6} reports the results. The interaction between cultural similarity and team average experience is positive for all three measures. For same nationality, however, the interaction is very small and statistically insignificant (0.0008, p=0.809). For shared language, the interaction is positive and statistically significant: \textcolor{blue}{0.0070 (p=0.029)}. \textcolor{blue}{For linguistic proximity, measured on a continuous scale, the interaction is positive but no statistically significant (0.0053, p=0.207)}
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity (C)  & 0.0361** & \textcolor{blue}{0.0394**} & \textcolor{blue}{0.0473**} \\
 & (0.0164) & \textcolor{blue}{(0.0157)} & \textcolor{blue}{(0.0203)} \\
C $\times$ exp\_mean\_dm & 0.0008 & \textcolor{blue}{0.0070**} & \textcolor{blue}{0.0053} \\
 & (0.0033) & (0.0032) & \textcolor{blue}{(0.0042)} \\
exp\_mean\_dm (main) & 0.0041* & 0.0002 & \textcolor{blue}{0.0007} \\
 & (0.0023) & (0.0025) & \textcolor{blue}{(0.0033)} \\
\midrule
Controls & Yes & Yes & Yes \\
Tournament $\times$ year FE & Yes & Yes & Yes \\
Round FE & Yes & Yes & Yes \\
Pseudo-$R^2$ & 0.096 & 0.098 & \textcolor{blue}{0.097} \\
$N$ & 3,728 & 3,728 & 3,728 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
The result is robust to allowing the interaction to vary nonlinearly with experience.
\textcolor{blue}{When we additionally include the interaction between cultural similarity and squared demeaned experience, the quadratic interactions remain small and statistically insignificant for all three measures.}

This pattern is consistent with a mechanism based on accumulated professional experience and the development of effective coordination. More experienced players may be more able to anticipate teammates' actions and establish efficient communication routines. Cultural and linguistic similarity may make these coordination processes more effective, so that their association with performance becomes stronger among more experienced teams. \textcolor{blue}{The fact that the amplification result is concentrated in shared official language, and absent for both shared nationality and the continuously-measured linguistic proximity, is consistent with a communication-based interpretation tied specifically to official/formal language use, rather than to cultural similarity or graded linguistic closeness more broadly.}
...
\subsubsection{Experience Gaps within the Team} 
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Culture (C) -- mean gap & 0.0356** & \textcolor{blue}{0.0408***} & \textcolor{blue}{0.0473**} \\
 & (0.0164) & \textcolor{blue}{(0.0157)} & \textcolor{blue}{(0.0203)} \\
C $\times$ exp\_gap\_dm & 0.0032 & \textcolor{blue}{0.0040} & \textcolor{blue}{0.0031} \\
 & (0.0034) & (0.0032) & \textcolor{blue}{(0.0041)} \\
exp\_gap\_dm (main) & $-$0.0036* & $-$0.0045* & \textcolor{blue}{$-$0.0043} \\
 & (0.0021) & (0.0025) & \textcolor{blue}{(0.0031)} \\
\midrule
...
The results provide no evidence that cultural similarity becomes more strongly associated with performance as the experience gap increases. The interaction is positive for all three measures—0.0032 for same nationality (p=0.344), \textcolor{blue}{0.0040 for same language (p=0.214)}, and \textcolor{blue}{0.0031 for linguistic proximity (p=0.447)}—but none is statistically significant. Allowing for a quadratic relationship between the experience gap and cultural similarity produces the same conclusion: the quadratic interactions are small and statistically insignificant, while the linear interactions remain insignificant.
...
\added{Partnership formation in professional doubles tennis is inherently multidimensional. Players may sort according to ability, experience, playing style, professional relationships, or commercial connections, among other considerations. We focus here on one dimension of this broader matching process: cultural similarity.}
...
\toprule
Measure & & All players & Both in top-100 & Both in top-50 \\
 & & ($N$=2,089) & ($N$=1,211) & ($N$=712) \\
\midrule
\multirow{2}{*}{Same nationality} & Actual & 42.2\% & 32.6\% & 35.5\% \\
 & Random benchmark & 5.2\% & 4.1\% & 4.5\% \\[.3cm]
\multirow{2}{*}{Same language} & Actual & \textcolor{blue}{56.7\%} & \textcolor{blue}{49.8\%} & 56.3\% \\
 & Random benchmark & \textcolor{blue}{16.3\%} & 15.5\% & 15.8\% \\[.3cm]
\multirow{2}{*}{\textcolor{blue}{Ling.\ proximity (mean)}} & Actual & \textcolor{blue}{0.654} & \textcolor{blue}{0.603} & \textcolor{blue}{0.632} \\
 & Random benchmark & \textcolor{blue}{0.364} & \textcolor{blue}{0.361} & \textcolor{blue}{0.375} \\
\bottomrule
\end{tabularx}
\begin{tablenotes}
\small
...
The results in Table~\ref{tab:t8} show substantial cultural sorting. Among all partnerships, 42.2\% consist of players of the same nationality, compared with 5.2\% under random matching. Similarly, \textcolor{blue}{56.7\%} of partnerships share an official language, compared with \textcolor{blue}{16.3\%} under random matching. \textcolor{blue}{Mean linguistic proximity is 0.654 among observed partnerships, compared with 0.364 under random matching.} Thus, doubles partnerships are strongly assortative along all three dimensions of cultural similarity.
...
We regress each cultural-similarity measure on the focal player's own doubles ranking, including tournament-by-year fixed effects. \added{Because the cultural composition of the player pool differs across tournament-years, a player's probability of having a culturally similar partner may vary mechanically with the set of players entering the event. We therefore extend the specification to also account for the cultural composition of the tournament field: for each focal player, the share of every \emph{other} player in that tournament-year's full field (every entrant, not only the rank-complete partnerships used above) who shares the focal player's nationality, and the analogous mean pairwise value of \textit{same\_language}/\textit{ling\_prox} against every other player in the field, matched to the corresponding outcome.} The specification is deliberately parsimonious: the purpose is not to explain partner selection comprehensively, but to test whether a player's own ranking predicts the cultural similarity of the partner within a given tournament-year, and whether that association survives controlling for field composition.

\textcolor{blue}{Formally, for a focal player from country $c$ entering a tournament-year field of $N$ total entrants (every player who appears in at least one match at that event, not merely the rank-complete partnerships used in Table~\ref{tab:t8}), the nationality field-composition measure is $\text{composition}_{nat}(c) = \#\{\text{other field entrants from country } c\} \, / \, (N-1)$; the language and linguistic-proximity composition measures replace the numerator with the sum, over every other field entrant $j$, of \textit{same\_language}$(c,j)$ or \textit{ling\_prox}$(c,j)$ respectively, again divided by $N-1$. As an illustration, at Roland Garros 2019 the host nation contributed with the highest number of players (20 of 128 entrants); an Italian player that year faced a field of 4 (Berrettini, Sonego, Seppi, Cecchinato) total Italians (3 others besides himself) among 127 other entrants, giving $\text{composition}_{nat}=\text{composition}_{lang}=3/127=0.024$, since no other nationality present in that field shared Italian as an official language. The corresponding linguistic-proximity composition is substantially higher, at $0.344$: although almost no entrant shared Italian officially, many were linguistically related to it, as France's 20 entrants alone, each scoring \textit{ling\_prox}$=0.5$ against Italian (both Romance languages, same branch but different sub-branch of the Ethnologue tree), contributed $20\times0.5=10.0$ to the numerator, roughly a quarter of that player's entire composition score that year.}

The results are reported in Table~\ref{tab:t9}. In Spec 1 (own ranking alone), the coefficient on own ranking is positive and statistically significant for all three measures: 0.000269 for same nationality (p<0.001), \textcolor{blue}{0.000173 for same language (p=0.004)}, and \textcolor{blue}{0.000107 for linguistic proximity (p=0.012; OLS coefficient rather than AME, since this measure is continuous)}. Because a lower doubles-ranking number indicates a stronger player, the positive coefficient means that worse-ranked players are, if anything, more likely to have culturally similar partners.


\added{We estimate three specifications: (1) own ranking alone (as above); (2) the outcome-matched field-composition variable alone; and (3) own ranking plus field composition. All three specifications exclude the 3 ego-rows whose own nationality is represented by exactly one player in the ego-row sample, so that a single lone-nationality observation cannot by itself drive any coefficient; this leaves $N=4{,}175$ (from 4,178) throughout.}

\begin{table}[htbp]
\color{red}
\centering
\caption{Own Ranking, Tournament-Field Composition, and Partner-Culture Similarity \label{tab:t9}}
\begin{threeparttable}
\begin{tabular}{llccc}
\toprule
Outcome & Variable & Spec 1 & Spec 2 & Spec 3 \\
\midrule
\multirow{4}{*}{Same nationality (AME)}
 & own\_rank & 0.000269*** & & 0.000116** \\
 & & (0.000056) & & (0.000053) \\
 & composition & & 3.853*** & 3.756*** \\
 & & & (0.241325) & (0.255403) \\
\addlinespace
\multirow{4}{*}{Same language (AME)}
 & own\_rank & \textcolor{blue}{0.000173***} & & \textcolor{blue}{0.000141***} \\
 & & \textcolor{blue}{(0.000059)} & & \textcolor{blue}{(0.000054)} \\
 & composition & & \textcolor{blue}{1.253***} & \textcolor{blue}{1.243***} \\
 & & & \textcolor{blue}{(0.083032)} & \textcolor{blue}{(0.084079)} \\
\addlinespace
\multirow{4}{*}{\textcolor{blue}{Ling.\ proximity (OLS coef.)}}
 & own\_rank & \textcolor{blue}{0.000107**} & & \textcolor{blue}{0.000098***} \\
 & & \textcolor{blue}{(0.000043)} & & \textcolor{blue}{(0.000036)} \\
 & composition & & \textcolor{blue}{1.378***} & \textcolor{blue}{1.375***} \\
 & & & \textcolor{blue}{(0.070657)} & \textcolor{blue}{(0.070942)} \\
\midrule
\multicolumn{2}{l}{$N$ (ego-rows)} & 4,175 & 4,175 & 4,175 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
...
Taken together, the partnership-formation evidence provides two useful qualifications to the performance analysis. First, cultural sorting in doubles is substantial: culturally similar partnerships are much more common than random matching would imply. Second, the sorting does not appear to be disproportionately concentrated among higher-ranked players. These findings do not eliminate selection as a possible source of the performance association, but they make the specific explanation that stronger players systematically select culturally similar partners less consistent with the data.
...
Same language & \textcolor{blue}{55.1\%} & \textcolor{blue}{55.3\%} & \textcolor{blue}{55.1\%} & \textcolor{blue}{54.3\%} & \textcolor{blue}{58.4\%} & 58.8\% \\
\textcolor{blue}{Ling.\ proximity (mean)} & \textcolor{blue}{0.619} & \textcolor{blue}{0.660} & \textcolor{blue}{0.651} & \textcolor{blue}{0.649} & \textcolor{blue}{0.664} & \textcolor{blue}{0.683} \\
\midrule
...
The share of same-nationality teams is remarkably stable across the Tokyo cycle's three periods, at 40.0\%, 40.3\%, and 39.0\%, respectively (Table~\ref{tab:t2ab}). The corresponding shares for shared official language are \textcolor{blue}{55.1\%, 55.3\%, and 55.1\%}, while \textcolor{blue}{mean linguistic proximity is 0.619, 0.660, and 0.651}.
...
The Paris cycle provides a contrasting pattern (Table~\ref{tab:t2ab} and Figure~\ref{fig:cycle_nat}). Same-nationality partnerships account for 39.3\% of teams before the Paris Games, 42.6\% during the preparation period, and 43.9\% afterwards. Shared-language partnerships increase from \textcolor{blue}{54.3\% to 58.4\%} and then 58.8\%, while \textcolor{blue}{mean linguistic proximity rises from 0.649 to 0.664 and then 0.683}.
...
\section{Conclusion}
\added{In a world filled with global freelance platforms, decentralized autonomous organizations (DAOs), academic networks, and highly autonomous consultancies, individuals act as their own human resource managers.}
...
\added{While prior literature often evaluates team diversity through the lens of centralized, top-down managerial assignment, our findings offer vital insights for the expanding landscape of decentralized, self-organized collaborations. For the autonomous professional navigating global knowledge markets, we show that cultural homophily is not merely a psychological comfort, but a rational coordination subsidy that enhances performance under real-time strategic constraints. However, we identify a sharp boundary condition for individual strategy: the value of this cultural conduit is strictly dependent on the availability of strategic communication windows and the total pool of accumulated human capital. When tasks transition into hyper-velocity execution shocks governed by universal, protocol-driven signaling, the homophily premium evaporates. For organizational designers, this reveals that team performance can be dynamically managed not by forcing composition, but by structurally altering the temporal architecture of the task environment.}
...
\added{While our empirical setting offers unique advantages in terms of observable effort, organic team formation, and clean performance metrics, several limitations remain that present fruitful avenues for future research. First, we emphasize that our empirical strategy identifies robust conditional associations rather than definitive causal effects. Although our models include comprehensive controls for individual and opponent capabilities, team experience, and tournament-by-year fixed effects—and our subsequent analysis rules out the alternative explanation that higher-ability actors systematically sort into homogeneous clusters—we cannot entirely eliminate the presence of unobservable, time-varying confounders. Factors such as unmeasured personal compatibility, real-time physical fatigue, or unobserved shared training histories could simultaneously influence both the decision to collaborate and the probability of match success. Future research utilizing true exogenous assignment of partners within high-velocity, real-time execution environments would be required to firmly establish a causal interpretation of the coordination channels we document. Second, while our findings demonstrate that the positive association between cultural similarity and performance completely disappears under the acute time shocks of tiebreaks, our data structure does not allow us to directly record the exact verbal or non-verbal content of the communication occurring during the 90-second changeovers versus between points. We infer that this null finding is driven by a structural shift from explicit strategic troubleshooting to standardized, protocol-driven tactical signaling. Future organizational studies could build upon our framework by capturing granular audio or visual tracking of self-organized teams in action, explicitly measuring how the linguistic complexity of real-time pivots changes as communication windows shrink. Finally, our sample is exclusively restricted to professional men's teams operating in a hyper-competitive sports environment. Examining whether these conditional associations and temporal boundaries hold in other decentralized, self-organized knowledge settings—such as cross-border high-frequency trading duos or remote open-source software crisis units—would greatly enhance the generalizability of our findings.}
...
\newpage
\appendix
\section{Alternative Measures of Linguistic Proximity}
\label{app:langprox}

\added{The main text measures linguistic proximity using the continuous $[0,1]$ index of \citet{melitztoubal2014}, built from Ethnologue's language-tree classification (the same measure used by \citet{bekesottaviano2025}). This Appendix reports every main-text regression table (3, 4, 5, 6, 6b) re-estimated with three alternative constructions of linguistic proximity, one at a time, in place of the main-text measure: (i) the original binary CEPII \textit{comlang\_ethno} indicator; and two further continuous, independently-constructed robustness measures from \citet{psw2024}, (ii) an inverted tree-distance index and (iii) a cognate/lexical-based proximity index. Both \citet{psw2024} measures are built on the same underlying idea as the main-text measure: languages related through a common ancestor are scored as linguistically closer; but are built from independently-constructed data with substantially broader language coverage. The tree-based measure computes, for any two languages, the ratio of the shortest path between them in Ethnologue's full language-family tree (6,737 languages) to the length of the path connecting them via the tree's root, giving a continuous distance on $[0,1]$ that we invert into a proximity measure; as with the main-text measure, country-pair values are population-weighted averages over each country's spoken languages. The cognate-based measure instead scores two languages by the share of a core vocabulary list (584 concepts, drawn from the intersection of the Intercontinental Dictionary Series, Princeton WordNet, and the CogNet cognate database covering 338 languages) for which the two languages have cognate words (i.e., words descending from the same etymological root) again aggregated to the country-pair level by population share. All three achieve complete coverage on our sample. Every table below uses the identical sample, controls, and fixed effects as its main-text counterpart.}

\begin{table}[htbp]
\centering
\caption{Appendix A3 -- Match Win, Linguistic Proximity Robustness (cf.\ Table~\ref{tab:t3}) \label{tab:a3}}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
 & (1) Binary (comlang\_ethno) & (2) PSW tree & (3) PSW cognate \\
\midrule
Linguistic proximity & \textcolor{blue}{0.0380**} & 0.0648*** & 0.0719*** \\
 & (0.0157) & (0.0231) & (0.0231) \\
Own avg. doubles ranking & $-$0.0007*** & $-$0.0007*** & $-$0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0007*** & 0.0007*** & 0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1)& \textcolor{blue}{$-$0.0026} & $-$0.0038 & $-$0.0034 \\
 & (0.0315) & (0.0314) & (0.0315) \\
Team avg. professional years  & 0.0042** & 0.0046*** & 0.0047*** \\
 & (0.0017) & (0.0017) & (0.0017) \\
Team avg. professional years$^2$  & \textcolor{blue}{$-$0.0007***} & $-$0.0008*** & $-$0.0008*** \\
 & (0.0002) & (0.0002) & (0.0002) \\
\midrule
Tournament $\times$ year FE & Yes & Yes & Yes \\
Match round FE & Yes & Yes & Yes \\
Pseudo-$R^2$ & \textcolor{blue}{0.096} & 0.097 & 0.097 \\
$N$ & 3,728 & 3,728 & 3,728 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item *** p$<$0.01, ** p$<$0.05, * p$<$0.10. Standard errors in parentheses, clustered by match. Column (1) reproduces the pre-2026-09-10 main-text Table~\ref{tab:t3} column (3) exactly. Columns (2)-(3) AME reported per full-scale (0$\to$1) change.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
\begin{table}[htbp]
\centering
\caption{Appendix A4 -- Tiebreak Win, Linguistic Proximity Robustness (cf.\ Table~\ref{tab:t4}) \label{tab:a4}}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
 & (1) Binary (comlang\_ethno) & (2) PSW tree & (3) PSW cognate \\
\midrule
Linguistic proximity & \textcolor{blue}{0.0031} & 0.0592* & 0.0572* \\
 & (0.0217) & (0.0312) & (0.0321) \\
Own avg. doubles ranking & $-$0.0003*** & $-$0.0003*** & $-$0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0003*** & 0.0003*** & 0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1) & \textcolor{blue}{$-$0.0645} & $-$0.0684 & $-$0.0677 \\
 & (0.0427) & (0.0428) & (0.0428) \\
Team avg. professional years & 0.0022 & 0.0029 & 0.0029 \\
 & (0.0021) & (0.0022) & (0.0022) \\
Team avg. professional years$^2$ & 0.0001 & 0.0000 & 0.0000 \\
 & (0.0003) & (0.0003) & (0.0003) \\
\midrule
Tournament $\times$ year FE & Yes & Yes & Yes \\
Round FE & Yes & Yes & Yes \\
Pseudo-$R^2$ & 0.013 & 0.014 & 0.014 \\
$N$ & 2,354 & 2,354 & 2,354 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item *** p$<$0.01, ** p$<$0.05, * p$<$0.10. Standard errors in parentheses, clustered by match. Column (1) reproduces the pre-2026-09-10 main-text Table~\ref{tab:t4} column (3) exactly.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
\begin{table}[htbp]
\centering
\caption{Appendix A5 -- Culture $\times$ Surface, Linguistic Proximity Robustness (cf.\ Table~\ref{tab:t5}) \label{tab:a5}}
\begin{threeparttable}
\begin{tabular}{lcccccc}
\toprule
 & \multicolumn{2}{c}{(1) Binary} & \multicolumn{2}{c}{(2) PSW tree} & \multicolumn{2}{c}{(3) PSW cognate} \\
 & (a) grass & (b) clay & (a) grass & (b) clay & (a) grass & (b) clay \\
\midrule
Cultural similarity (C) & \textcolor{blue}{0.0369**} & \textcolor{blue}{0.0365**} & 0.0687*** & 0.0610** & 0.0751*** & 0.0708*** \\
 & (0.0176) & (0.0181) & (0.0256) & (0.0268) & (0.0257) & (0.0268) \\
Surface & \textcolor{blue}{$-$0.0003} & \textcolor{blue}{$-$0.0032} & 0.0148 & $-$0.0083 & 0.0133 & $-$0.0018 \\
 & (0.0209) & \textcolor{blue}{(0.0195)} & (0.0337) & (0.0308) & (0.0340) & (0.0314) \\
C $\times$ Surface & \textcolor{blue}{0.0045} & \textcolor{blue}{0.0051} & $-$0.0197 & 0.0124 & $-$0.0171 & 0.0021 \\
 & (0.0364) & (0.0344) & (0.0539) & (0.0492) & (0.0536) & (0.0495) \\
\midrule
Controls  & Yes & Yes & Yes & Yes & Yes & Yes \\
Round FE & Yes & Yes & Yes & Yes & Yes & Yes \\
Tournament $\times$ year FE & No & No & No & No & No & No \\
Pseudo-$R^2$ & 0.096 & 0.096 & 0.097 & 0.097 & 0.097 & 0.097 \\
$N$ & \multicolumn{2}{c}{3,728} & \multicolumn{2}{c}{3,728} & \multicolumn{2}{c}{3,728} \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item *** p$<$0.01, ** p$<$0.05, * p$<$0.10. Standard errors in parentheses, clustered by match. Column (1) reproduces the pre-2026-09-10 main-text Table~\ref{tab:t5} column (3) exactly.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
\begin{table}[htbp]
\centering
\caption{Appendix A6 -- Culture $\times$ Years Since Turning Pro, Linguistic Proximity Robustness (cf.\ Table~\ref{tab:t6}) \label{tab:a6}}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
 & (1) Binary & (2) PSW tree & (3) PSW cognate \\
\midrule
Cultural similarity (C)  & \textcolor{blue}{0.0353**} & 0.0642*** & 0.0705*** \\
 & (0.0156) & (0.0230) & (0.0231) \\
C $\times$ exp\_mean\_dm & \textcolor{blue}{0.0069**} & 0.0048 & 0.0053 \\
 & (0.0032) & (0.0047) & (0.0047) \\
exp\_mean\_dm (main) & \textcolor{blue}{0.0000} & \multicolumn{1}{c}{--} & \multicolumn{1}{c}{--} \\
 & (0.0025) & & \\
\midrule
Controls & Yes & Yes & Yes \\
Tournament $\times$ year FE & Yes & Yes & Yes \\
...
\begin{tablenotes}
\small
\item *** p$<$0.01, ** p$<$0.05, * p$<$0.10. Standard errors in parentheses, clustered by match. Column (1) reproduces the pre-2026-09-10 main-text Table~\ref{tab:t6} column (3) exactly and is the specification with a statistically significant culture $\times$ experience interaction referenced in Section~5. Columns (2)-(3)'s main exp\_mean\_dm control coefficient was not separately recorded in this run; the interaction and C-main rows are unaffected.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
\begin{table}[htbp]
\centering
\caption{Appendix A6b -- Culture $\times$ Within-Team Experience Gap, Linguistic Proximity Robustness (cf.\ Table~\ref{tab:t6b}) \label{tab:a6b}}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
 & (1) Binary & (2) PSW tree & (3) PSW cognate \\
\midrule
Culture (C) -- mean gap & \textcolor{blue}{0.0370**} & 0.0620*** & 0.0690*** \\
 & (0.0157) & (0.0231) & (0.0231) \\
C $\times$ exp\_gap\_dm & \textcolor{blue}{0.0038} & 0.0052 & 0.0052 \\
 & (0.0032) & (0.0048) & (0.0047) \\
exp\_gap\_dm (main) & \textcolor{blue}{$-$0.0046*} & $-$0.0055 & $-$0.0055 \\
 & (0.0025) & (0.0034) & (0.0033) \\
\midrule
Controls (Table~\ref{tab:t3} set) & Yes & Yes & Yes \\
Tournament $\times$ year FE & Yes & Yes & Yes \\
Round FE & Yes & Yes & Yes \\
Pseudo-$R^2$ & 0.097 & 0.097 & 0.098 \\
$N$ & 3,728 & 3,728 & 3,728 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item *** p$<$0.01, ** p$<$0.05, * p$<$0.10. Standard errors in parentheses, clustered by match. Column (1) reproduces the pre-2026-09-10 main-text Table~\ref{tab:t6b} column (3) exactly.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier

\added{Across every table, the binary CEPII measure and the two PSW2024 continuous measures agree qualitatively with the main-text linguistic-proximity results, with one exception noted in Section~5: the binary measure's culture $\times$ experience interaction (Appendix Table~\ref{tab:a6}, column 1) is statistically significant, while the main-text linguistic-proximity interaction and both PSW2024 robustness interactions are not.}

\section{Robustness to Double-Counting: One Randomly-Selected Team per Match}
\label{app:randone}

\textcolor{blue}{Table~\ref{tab:t3} contributes two observations per match (winner team and loser team), which are mechanically related: a win for one team is a loss for the other. Clustering standard errors by match already accounts for this non-independence, but as a further check we re-estimate the Table~\ref{tab:t3} specification keeping exactly one, randomly selected team per match ($N=1{,}864$), which removes the mechanical win/loss complementarity entirely.}

\begin{table}[htbp]
\centering
\caption{Appendix B1 -- Match Win, One Randomly-Selected Team per Match (cf.\ Table~\ref{tab:t3}) \label{tab:b1}}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity & 0.0466 & 0.0517 & 0.0656 \\
 & (0.0220)$^{5/10}$ & (0.0205)$^{7/10}$ & (0.0242)$^{7/10}$ \\
Own avg. doubles ranking & $-$0.0007 & $-$0.0007 & $-$0.0007 \\
 & (0.0001)$^{10/10}$ & (0.0001)$^{10/10}$ & (0.0001)$^{10/10}$ \\
Opponent avg. doubles ranking & 0.0008 & 0.0008 & 0.0008 \\
 & (0.0001)$^{10/10}$ & (0.0001)$^{10/10}$ & (0.0001)$^{10/10}$ \\
Top-100 singles player (0,1) & $-$0.0099 & $-$0.0078 & $-$0.0080 \\
 & (0.0359)$^{0/10}$ & (0.0356)$^{0/10}$ & (0.0354)$^{0/10}$ \\
Team avg. professional years & 0.0050 & 0.0047 & 0.0049 \\
 & (0.0019)$^{7/10}$ & (0.0018)$^{7/10}$ & (0.0019)$^{7/10}$ \\
Team avg. professional years$^2$ & $-$0.0008 & $-$0.0008 & $-$0.0008 \\
 & (0.0003)$^{7/10}$ & (0.0003)$^{7/10}$ & (0.0003)$^{7/10}$ \\
\midrule
Tournament $\times$ year FE & Yes & Yes & Yes \\
Match round FE & Yes & Yes & Yes \\
Pseudo-$R^2$ (mean) & 0.112 & 0.113 & 0.113 \\
$N$ (per draw) & 1,864 & 1,864 & 1,864 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item Each draw keeps exactly one team per match (coin flip, $N=1{,}864$), estimated with the same controls and fixed effects (tournament $\times$ year, round) as Table~\ref{tab:t3}, with robust (HC1) standard errors in place of match-clustering. Statistics computed across 10 independent random seeds. Each coefficient is the mean AME across the 10 draws; the number in parentheses is the standard deviation of that AME \emph{across draws}. The superscript after each parenthesis instead reports, for that coefficient in that column, how many of the 10 individual draws were significant at the 5\% level \emph{in that draw's own regression}.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier

\textcolor{blue}{The randomly-selected-team specification produces AMEs of similar magnitude to Table~\ref{tab:t3}'s main estimates for all three measures, with somewhat weaker and less stable significance, as expected given the sample is halved and no longer benefits from the efficiency gain of clustering two related observations per match.\\}

\section{Disentangling Nationality from Language}
\label{app:natlang}

\textcolor{blue}{We assume that same nationality implies same language: in this sample, every same-nationality team-obs also has same\_language$=1$ (0 same-nationality/different-language team-obs exist). Under this assumption, the same-nationality-\&-same-language dummy is identical to \texttt{same\_country} (Table~\ref{tab:t3}, column 1), so we do not re-report it. We therefore report only the informative comparison: different nationality \& same language ($N=575$, win rate $0.5565$) versus everyone else ($N=3{,}153$, win rate $0.4897$), e.g.\ Germany/Austria, UK/Australia/US, Spain/Argentina, entered as a single dummy against the full remaining sample (same controls, fixed effects, and clustering as Table~\ref{tab:t3}).}

\begin{table}[htbp]
\centering
\caption{Appendix C1 -- Match Win, Different Nationality \& Same Language vs.\ Everyone Else (cf.\ Table~\ref{tab:t3}) \label{tab:c1}}
\begin{threeparttable}
\begin{tabular}{lc}
\toprule
 & Diff.\ Nationality \& Same Language \\
\midrule
Culture-category dummy & 0.0156 \\
 & (0.0215) \\
Own avg. doubles ranking & $-$0.0007$^{***}$ \\
 & (0.0001) \\
Opponent avg. doubles ranking & 0.0007$^{***}$ \\
 & (0.0001) \\
Top-100 singles player (0,1) & $-$0.0010 \\
 & (0.0314) \\
Team avg. professional years & 0.0037$^{**}$ \\
 & (0.0017) \\
Team avg. professional years$^2$ & $-$0.0007$^{***}$ \\
 & (0.0002) \\
\midrule
Tournament $\times$ year FE & Yes \\
Round FE & Yes \\
Pseudo-$R^2$ & 0.095 \\
$N$ & 3,728 \\
\bottomrule
...
\textcolor{blue}{The performance association does not survive for different-nationality/same-language partnerships when tested against the full remaining sample ($p=0.467$) -- only the same-nationality category (Table~\ref{tab:t3}, column 1, $p=0.028$) is significant. This is evidence against a purely communication/language-driven channel and is more consistent with nationality-specific mechanisms (shared sporting institutions, geographic proximity, prior junior-circuit exposure).}
