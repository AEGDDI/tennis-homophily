...
\label{tab:t2}
\begin{threeparttable}
\textbf{Panel A: Shares of the Three Cultural Similarity Measures (N = 3,752 team-obs)}\\[2pt]
\begin{tabular}{lc}
\toprule
...
\vspace{10pt}
\textbf{Panel B: Unique Teams (Partnerships) by Tournament}\\[2pt]
\begin{tabular}{lc}
\toprule
Tournament & Teams \\
\midrule
...
\begin{tablenotes}
\small
\item Note: Panel B counts distinct tournament$\times$partnership pairings with complete ranking data (Section~\ref{sec:sorting} sample), not team-match observations -- a pair advancing through several rounds of the same event is counted once.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
