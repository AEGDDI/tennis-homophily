...
Table 2: \textcolor{red}{I would remove Panel B and add the absolute number of partnerships next to the share in Panel A, 42.2\%=X teams for each of the 3 measure.}  In our sample,  \textcolor{red}{42.2\%} of teams consist of players sharing the same nationality, \textcolor{red}{56.0\%} share an official language, and \textcolor{blue}{the mean linguistic proximity (\textit{prox1}, continuous on $[0,1]$) is 0.651}.
...
Same language  & 56.0\% \\
\textcolor{blue}{Ling.\ proximity (mean, prox1)} & \textcolor{blue}{0.651} \\
\bottomrule
\end{tabular}%
}
&
...
\midrule
Cultural similarity & 0.0361** & 0.0459*** & \textcolor{blue}{0.0527***} \\
 & (0.0164) & (0.0157) & \textcolor{blue}{(0.0201)} \\
Own avg. doubles ranking & $-$0.0007*** & $-$0.0007*** & $-$0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0007*** & 0.0007*** & 0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1)& $-$0.0042 & $-$0.0030 & \textcolor{blue}{$-$0.0034} \\
 & (0.0315) & (0.0315) & \textcolor{blue}{(0.0314)} \\
Team avg. professional years  & 0.0044*** & 0.0043** & \textcolor{blue}{0.0044***} \\
...
\midrule
Cultural similarity (C) & 0.0395** & 0.0351* & 0.0439** & 0.0477*** & \textcolor{blue}{0.0565**} & \textcolor{blue}{0.0505**} \\
 & (0.0183) & (0.0189) & (0.0176) & (0.0182) & \textcolor{blue}{(0.0223)} & \textcolor{blue}{(0.0233)} \\
Surface & 0.0097 & $-$0.0017 & $-$0.0022 & 0.0047 & \textcolor{blue}{0.0158} & \textcolor{blue}{$-$0.0040} \\
 & (0.0149) & (0.0142) & (0.0207) & (0.0188) & \textcolor{blue}{(0.0306)} & \textcolor{blue}{(0.0283)} \\
C $\times$ Surface & $-$0.0169 & 0.0023 & 0.0070 & $-$0.0084 & \textcolor{blue}{$-$0.0203} & \textcolor{blue}{0.0055} \\
 & (0.0376) & (0.0347) & (0.0364) & (0.0340) & \textcolor{blue}{(0.0472)} & \textcolor{blue}{(0.0436)} \\
\midrule
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity & 0.0308 & 0.0082 & \textcolor{blue}{0.0397} \\
 & (0.0224) & (0.0218) & \textcolor{blue}{(0.0275)} \\
Own avg. doubles ranking & $-$0.0003*** & $-$0.0003*** & $-$0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0003*** & 0.0003*** & 0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1) & $-$0.0675 & $-$0.0646 & \textcolor{blue}{$-$0.0674} \\
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity (C)  & 0.0361** & 0.0433*** & \textcolor{blue}{0.0499**} \\
 & (0.0164) & (0.0157) & \textcolor{blue}{(0.0202)} \\
C $\times$ exp\_mean\_dm & 0.0008 & 0.0069** & \textcolor{blue}{0.0052} \\
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Culture (C) -- mean gap & 0.0356** & 0.0447*** & \textcolor{blue}{0.0498**} \\
 & (0.0164) & (0.0157) & \textcolor{blue}{(0.0202)} \\
C $\times$ exp\_gap\_dm & 0.0032 & 0.0038 & \textcolor{blue}{0.0032} \\
...
The results provide no evidence that cultural similarity becomes more strongly associated with performance as the experience gap increases. The interaction is positive for all three measures—0.0032 for same nationality (p=0.344), 0.0038 for same language (p=0.232), and \textcolor{blue}{0.0032 for linguistic proximity (p=0.431)}—but none is statistically significant. Allowing for a quadratic relationship between the experience gap and cultural similarity produces the same conclusion: the quadratic interactions are small and statistically insignificant, while the linear interactions remain insignificant.
...
\multirow{2}{*}{\textcolor{blue}{Ling.\ proximity (mean, prox1)}} & Actual & \textcolor{blue}{0.651} & \textcolor{blue}{0.601} & \textcolor{blue}{0.631} \\
 & Random benchmark & \textcolor{blue}{0.354} & \textcolor{blue}{0.348} & \textcolor{blue}{0.358} \\
\bottomrule
\end{tabularx}
\begin{tablenotes}
\small
...
The results are reported in Table~\ref{tab:t9}. In Spec 1 (own ranking alone), the coefficient on own ranking is positive and statistically significant for all three measures: 0.000269 for same nationality (p<0.001), 0.000146 for same language (p=0.012), and \textcolor{blue}{0.000098 for linguistic proximity (p=0.026; OLS coefficient rather than AME, since \textit{prox1} is continuous)}. Because a lower doubles-ranking number indicates a stronger player, the positive coefficient means that worse-ranked players are, if anything, more likely to have culturally similar partners.
...
\multirow{4}{*}{\textcolor{blue}{Ling.\ proximity (OLS coef., prox1)}}
 & own\_rank & \textcolor{blue}{0.000098**} & & \textcolor{blue}{0.000088**} \\
 & & \textcolor{blue}{(0.000044)} & & \textcolor{blue}{(0.000038)} \\
 & composition & & \textcolor{blue}{1.249***} & \textcolor{blue}{1.247***} \\
 & & & \textcolor{blue}{(0.116322)} & \textcolor{blue}{(0.117364)} \\
\midrule
...
\textcolor{blue}{Ling.\ proximity (mean, prox1)} & \textcolor{blue}{0.618} & \textcolor{blue}{0.660} & \textcolor{blue}{0.649} & \textcolor{blue}{0.646} & \textcolor{blue}{0.664} & \textcolor{blue}{0.675} \\
\midrule
