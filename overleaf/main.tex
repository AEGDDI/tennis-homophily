...
Table 2: \textcolor{red}{I would remove Panel B and add the absolute number of partnerships next to the share in Panel A, 42.2\%=X teams for each of the 3 measure.}  In our sample,  \textcolor{red}{42.2\%} of teams consist of players sharing the same nationality, \textcolor{red}{56.0\%} share an official language, and \textcolor{blue}{the mean of the continuous measure linguistic proximity is 0.654}.
...
Same language  & 56.0\% \\
\textcolor{blue}{Ling.\ proximity (mean)} & \textcolor{blue}{0.654} \\
\bottomrule
\end{tabular}%
}
&
...
\begin{tablenotes}
\small
\item Note: Panel A reports shares over the 2,089 distinct tournament$\times$partnership pairings with complete ranking data. Panel B counts the same 2,089 pairings, broken down by tournament.
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
\midrule
Cultural similarity & 0.0361** & 0.0459*** & \textcolor{blue}{0.0501**} \\
 & (0.0164) & (0.0157) & \textcolor{blue}{(0.0202)} \\
Own avg. doubles ranking & $-$0.0007*** & $-$0.0007*** & $-$0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0007*** & 0.0007*** & 0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1)& $-$0.0042 & $-$0.0030 & \textcolor{blue}{$-$0.0031} \\
 & (0.0315) & (0.0315) & \textcolor{blue}{(0.0314)} \\
Team avg. professional years  & 0.0044*** & 0.0043** & \textcolor{blue}{0.0043***} \\
...
\added{Alternative specification: randomly assign one team per match as the focal team to be kept in the regression analysis (N=1,864). Coefficients are of similar magnitude and slighter weaker significance.} Repeated over 10 random seeds (Appendix Table~\ref{tab:b1}): the same-nationality AME averages 0.0466 (range 0.0161--0.0812, significant at the 5\% level in 5 of 10 draws), same-language averages 0.0517 (range 0.0230--0.0877, significant in 7 of 10 draws), \textcolor{blue}{and, for linguistic proximity averages 0.0656 (range 0.0236--0.0944, significant in 7 of 10 draws)}.
...
\midrule
Cultural similarity (C) & 0.0395** & 0.0351* & 0.0439** & 0.0477*** & \textcolor{blue}{0.0541**} & \textcolor{blue}{0.0486**} \\
 & (0.0183) & (0.0189) & (0.0176) & (0.0182) & \textcolor{blue}{(0.0224)} & \textcolor{blue}{(0.0234)} \\
Surface & 0.0097 & $-$0.0017 & $-$0.0022 & 0.0047 & \textcolor{blue}{0.0158} & \textcolor{blue}{$-$0.0028} \\
 & (0.0149) & (0.0142) & (0.0207) & (0.0188) & \textcolor{blue}{(0.0308)} & \textcolor{blue}{(0.0285)} \\
C $\times$ Surface & $-$0.0169 & 0.0023 & 0.0070 & $-$0.0084 & \textcolor{blue}{$-$0.0203} & \textcolor{blue}{0.0034} \\
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity & 0.0308 & 0.0082 & \textcolor{blue}{0.0388} \\
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Cultural similarity (C)  & 0.0361** & 0.0433*** & \textcolor{blue}{0.0473**} \\
 & (0.0164) & (0.0157) & \textcolor{blue}{(0.0203)} \\
C $\times$ exp\_mean\_dm & 0.0008 & 0.0069** & \textcolor{blue}{0.0053} \\
...
\toprule
 & (1) Same Nationality & (2) Same Language & (3) Lang. Proximity \\
\midrule
Culture (C) -- mean gap & 0.0356** & 0.0447*** & \textcolor{blue}{0.0473**} \\
 & (0.0164) & (0.0157) & \textcolor{blue}{(0.0203)} \\
C $\times$ exp\_gap\_dm & 0.0032 & 0.0038 & \textcolor{blue}{0.0031} \\
...
The results provide no evidence that cultural similarity becomes more strongly associated with performance as the experience gap increases. The interaction is positive for all three measures—0.0032 for same nationality (p=0.344), 0.0038 for same language (p=0.232), and \textcolor{blue}{0.0031 for linguistic proximity (p=0.447)}—but none is statistically significant. Allowing for a quadratic relationship between the experience gap and cultural similarity produces the same conclusion: the quadratic interactions are small and statistically insignificant, while the linear interactions remain insignificant.
...
\multirow{2}{*}{Same language} & Actual & 56.0\% & 49.7\% & 56.3\% \\
 & Random benchmark & 16.2\% & 15.5\% & 15.8\% \\[.3cm]
...
The results are reported in Table~\ref{tab:t9}. In Spec 1 (own ranking alone), the coefficient on own ranking is positive and statistically significant for all three measures: 0.000269 for same nationality (p<0.001), 0.000146 for same language (p=0.012), and \textcolor{blue}{0.000107 for linguistic proximity (p=0.012; OLS coefficient rather than AME, since this measure is continuous)}. Because a lower doubles-ranking number indicates a stronger player, the positive coefficient means that worse-ranked players are, if anything, more likely to have culturally similar partners.
...
The share of same-nationality teams is remarkably stable across the Tokyo cycle's three periods, at 40.0\%, 40.3\%, and 39.0\%, respectively (Table~\ref{tab:t2ab}). The corresponding shares for shared official language are 54.8\%, 55.0\%, and 54.8\%, while \textcolor{blue}{mean linguistic proximity is 0.619, 0.660, and 0.651}.
...
\midrule
Linguistic proximity & 0.0419*** & 0.0648*** & 0.0719*** \\
 & (0.0157) & (0.0231) & (0.0231) \\
Own avg. doubles ranking & $-$0.0007*** & $-$0.0007*** & $-$0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0007*** & 0.0007*** & 0.0007*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1)& $-$0.0024 & $-$0.0038 & $-$0.0034 \\
...
\toprule
 & (1) Binary (comlang\_ethno) & (2) PSW tree & (3) PSW cognate \\
\midrule
Linguistic proximity & 0.0026 & 0.0592* & 0.0572* \\
 & (0.0217) & (0.0312) & (0.0321) \\
Own avg. doubles ranking & $-$0.0003*** & $-$0.0003*** & $-$0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Opponent avg. doubles ranking & 0.0003*** & 0.0003*** & 0.0003*** \\
 & (0.0001) & (0.0001) & (0.0001) \\
Top-100 singles player (0,1) & $-$0.0644 & $-$0.0684 & $-$0.0677 \\
...
\toprule
 ...
 & (a) grass & (b) clay & (a) grass & (b) clay & (a) grass & (b) clay \\
\midrule
Cultural similarity (C) & 0.0416** & 0.0401** & 0.0687*** & 0.0610** & 0.0751*** & 0.0708*** \\
 & (0.0176) & (0.0181) & (0.0256) & (0.0268) & (0.0257) & (0.0268) \\
Surface & 0.0019 & $-$0.0037 & 0.0148 & $-$0.0083 & 0.0133 & $-$0.0018 \\
 & (0.0209) & (0.0194) & (0.0337) & (0.0308) & (0.0340) & (0.0314) \\
C $\times$ Surface & 0.0003 & 0.0061 & $-$0.0197 & 0.0124 & $-$0.0171 & 0.0021 \\
...
\midrule
Cultural similarity (C)  & 0.0392** & 0.0642*** & 0.0705*** \\
 & (0.0156) & (0.0230) & (0.0231) \\
C $\times$ exp\_mean\_dm & 0.0068** & 0.0048 & 0.0053 \\
 & (0.0032) & (0.0047) & (0.0047) \\
exp\_mean\_dm (main) & 0.0002 & \multicolumn{1}{c}{--} & \multicolumn{1}{c}{--} \\
 & (0.0025) & & \\
\midrule
Controls & Yes & Yes & Yes \\
Tournament $\times$ year FE & Yes & Yes & Yes \\
...
\toprule
 & (1) Binary & (2) PSW tree & (3) PSW cognate \\
\midrule
Culture (C) -- mean gap & 0.0409*** & 0.0620*** & 0.0690*** \\
 & (0.0157) & (0.0231) & (0.0231) \\
C $\times$ exp\_gap\_dm & 0.0036 & 0.0052 & 0.0052 \\
 & (0.0032) & (0.0048) & (0.0047) \\
exp\_gap\_dm (main) & $-$0.0045* & $-$0.0055 & $-$0.0055 \\
